...
// upgrades alike) to the real Goalrail server, so the in-sandbox host's
...
export default {
  async fetch(request, env) {
    ...
    // X-Goalrail-Host-Token and the WebSocket Upgrade), and body.
