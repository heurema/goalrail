...
from goalrail._native_resume_hint import (
...
def test_format_native_resume_command_includes_remote_context() -> None:
    ...
    The command must carry the wrapper name, Goalrail server, and
    Goalrail conversation id. If any of those fields are dropped, a
