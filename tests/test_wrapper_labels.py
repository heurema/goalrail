...
import them from :mod:`goalrail._wrapper_labels`, and the server's
...
def test_claude_native_wrapper_constants_match_claude_native_module() -> None:
    """
    ``goalrail.claude_native`` imports the same key/value pair.
...
def test_claude_native_wrapper_constants_match_chat_module() -> None:
    """
    ``goalrail.chat`` imports the same key/value pair.
    ...
    drift here would mean ``goalrail attach <claude-id>``
    silently opens a Goalrail REPL on top of a tmux session it can't see —
...
def test_claude_native_wrapper_constants_match_picker_module() -> None:
    """
    ``goalrail.repl._resume_picker`` imports the same key/value pair.
    ...
    symptom.
    """
    from goalrail.repl import _resume_picker
...
def test_claude_native_wrapper_constants_match_server_routes() -> None:
    """
    ``goalrail.server.routes.sessions`` carries its own copy of the
...
def test_codex_native_wrapper_constants_match_codex_native_module() -> None:
    """
    ``goalrail.codex_native`` imports the same key/value pair.
...
def test_codex_native_wrapper_constants_match_picker_module() -> None:
    """
    ``goalrail.repl._resume_picker`` imports the Codex wrapper value.
...
def test_pi_native_wrapper_constants_match_pi_native_module() -> None:
    """``goalrail.pi_native`` imports the same key/value pair."""
    from goalrail import pi_native
...
def test_pi_native_wrapper_constants_match_registry() -> None:
    ...
    from goalrail.native_coding_agents import PI_NATIVE_CODING_AGENT
...
def test_kiro_native_wrapper_constants_match_registry() -> None:
    ...
    from goalrail.native_coding_agents import KIRO_NATIVE_CODING_AGENT
