"""Tests for ``_evaluate_policy_via_goalrail`` fail-open / fail-closed.

The runner proxies harness policy-evaluation requests to the Goalrail
...
from goalrail.runner.app import _evaluate_policy_via_goalrail
...
async def _run(server_client: Any, phase: str) -> dict[str, Any]:
    ...
    :param server_client: Stub Goalrail-server client.
    ...
    await _evaluate_policy_via_goalrail(
