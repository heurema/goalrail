...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"goalrail.codex_native.bypass_sandbox": "0"},  # explicit off
        {"goalrail.codex_native.bypass_sandbox": "true"},  # only "1" arms it
        {"goalrail.codex_native.bypass_sandbox": ""},  # empty string
    ],
)
