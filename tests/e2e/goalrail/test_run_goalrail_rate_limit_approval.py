...
def test_run_goalrail_rate_limit_approval_round_trip(
    ...
    :param goalrail_python: Path to the worktree's
        ``.venv/bin/python``.
    :param goalrail_repo_root: Repo root the subprocess uses as
    ...
    try:
        ...
        # :func:`goalrail.repl._repl._make_elicitation_prompt`'s
