...
- Goalrail' policy engine regresses.
...
def test_yaml_policies_blocks_canada_input(
    ...
    """
    ``goalrail run agent_with_policies.yaml --harness <harness>
    ...
    yaml_path = (
        goalrail_repo_root / "tests" / "resources" / "examples" / "agent_with_policies.yaml"
    )
