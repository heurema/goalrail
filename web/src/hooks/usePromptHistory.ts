...
// against ~/.goalrail_history). Web-side, history persists across tabs and
...
const STORAGE_PREFIX = "goalrail:prompt-history";
 ...
 * @returns The localStorage key, e.g. ``"goalrail:prompt-history:conv_abc123"``.
 */
