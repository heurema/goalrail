 ...
 * membership. Namespaced (`goalrail.*`) so it never collides with the
 * user-facing "project" term or other reserved keys, and is filtered out of
 * generic label surfaces.
 */
export const PROJECT_LABEL_KEY = "goalrail.project";
 ...
 * sessions keep their `goalrail.project` label (so unarchiving restores them to
