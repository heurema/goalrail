...
export interface AvailableAgent {
  ...
  // same-named `goalrail run` upload, but lets a newer upload supersede a
 ...
 *   wins, so a fresh `goalrail run agent.yaml` supersedes a stale template
