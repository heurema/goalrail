...
/**
 * Desktop-only: shows which Goalrail CLI binary the shell resolved
...
function LocalCliSection() {
  ...
  return (
    <Section
      title="Local CLI"
      description="The Goalrail command-line tool this app uses to run a local server and connect this machine as a runner."
    >
      {status === null ? (
          ...
          {status.path ? (
            ...
            <div className="flex flex-col gap-2">
              <p className="text-sm text-muted-foreground">
                The Goalrail CLI wasn't found. Install it, then set its path from the connect
                screen:
              </p>
