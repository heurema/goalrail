...
export function Sidebar({ open, onClose, dragProgress = null }: SidebarProps) {
  ...
  // `inert` isn't a recognized boolean DOM property in this React/react-dom
  // version, so passing it as a JSX prop (either true or false) logs a
  // "non-boolean attribute" console warning — set it imperatively instead,
  // matching FilesPanelDrawer/TerminalsPanel/ExecutionLogsPanel.
