  ...
  func setBadgeCount(_ count: Int) {
    Task {
      ...
      do {
        ...
        NSLog("[goalrail] failed to set badge count: \(String(describing: error))")
      }
    }
  }
  ...
  func notify(title: String, body: String?, navigatePath: String?) {
    Task {
      ...
      let request = UNNotificationRequest(
        identifier: "goalrail.\(UUID().uuidString)",
        content: content,
        trigger: nil
      )
      ...
      do {
        ...
        NSLog("[goalrail] failed to add notification: \(String(describing: error))")
      }
    }
  }
