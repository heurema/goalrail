# Canary Integrity Hardening Specification

## Purpose

Define local evidence transaction safety, durable wrong-join projection, and provenance preservation for wording-only intent amendments.
