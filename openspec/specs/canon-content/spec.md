# canon-content Specification

## Purpose

Define the authoring and compatibility requirements that keep Goalrail canon
artifacts traceable, verifiable, and readable by both current and legacy
consumers.
