# Artifact Conformance Specification

## Purpose

Define the versioned contract, safe diagnostics, and deterministic conformance
evidence for Context Pack and Intent Snapshot pairs across their direct
consumers.
