...
|---|---|---|
| NG-1 | This milestone creates only `proposal.md` from the confirmed intent. It does not create specs, design, tasks, implementation, a real run, activation, or Git and deployment actions. | SE-4, SE-7, CTX-2, CTX-8 |
...
| SIG-7 | This planning cycle stops after the proposal. | OpenSpec reports `context.md`, confirmed `intent.md`, and `proposal.md` present while specs, design, tasks, implementation, and activation remain absent. | SE-4, SE-7, CTX-2, CTX-3 |
...
- **Confirmed at:** 2026-07-23T07:06:28Z
- **Verification action:** The owner reviewed the exact proposal-only amendment to version 1 and explicitly replied `yes`, confirming version 2.
