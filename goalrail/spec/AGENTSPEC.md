...
Enables built-in tools provided by goalrail. Each entry is either a plain
...
registration boundary (`goalrail.cli._resolve_bundle_env_vars`), never
...
**Security note — SSRF risk:** The goalrail server makes outbound HTTP
