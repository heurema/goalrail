...
into the Goalrail conversation with ``external_conversation_item`` events.
"""
...
from goalrail.kiro_native_bridge import write_forwarder_ready
...
def _discover_kiro_session_jsonl(
    *,
    ...
    """Find this Goalrail session's Kiro JSONL file."""
...
async def _patch_external_session_id(
    ...
    *,
    ...
    """Persist Kiro's native CLI session id onto the Goalrail session."""
...
async def forward_kiro_session_to_goalrail(
    *,
    base_url: str,
...
async def supervise_kiro_session_forwarder(
    *,
    ...
    while True:
        ...
        try:
            await forward_kiro_session_to_goalrail(
                base_url=base_url,
                headers=headers,
                session_id=session_id,
...
__all__ = [
    "forward_kiro_session_to_goalrail",
