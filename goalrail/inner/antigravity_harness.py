...
:mod:`goalrail.runtime.harnesses._runner` invokes after the parent resolves
``"antigravity"`` via :data:`goalrail.runtime.harnesses._HARNESS_MODULES`. It
wraps a :class:`~goalrail.inner.antigravity_executor.AntigravityExecutor` in an
...
from goalrail.inner.antigravity_executor import AntigravityExecutor
