...
Wraps a :class:`goalrail.inner.cursor_executor.CursorExecutor`, which
...
from goalrail.inner.cursor_executor import CursorExecutor
...
def _resolve_os_env() -> OSEnvSpec:
    ...
    Decodes the JSON-encoded dict Goalrail serialized via
