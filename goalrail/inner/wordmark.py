...
banner (TTY gating, ``GOALRAIL_NO_BANNER``) lives one layer up in
:mod:`goalrail.inner.ui`, which is the only module that should be imported
...
def render_lockup(
    ...
    *,
    ...
    :param epilogue: Optional aligned label/value rows printed beneath the
        art, e.g. ``[("Version", "0.4.2"), ("Next", "goalrail setup")]``.
    :returns: None.
    """
