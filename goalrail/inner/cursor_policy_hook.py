"""Cursor preToolUse hook script for Goalrail policy enforcement.
...
PHASE_TOOL_CALL policy via the Goalrail server, and returns the
verdict on stdout.
...
def main() -> None:
    ...
    if action == "POLICY_ACTION_DENY":
        ...
        if reason:
            out["agent_message"] = f"Tool '{tool_name}' denied by Goalrail policy: {reason}"
