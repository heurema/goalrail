...
around a :class:`goalrail.inner.hermes_executor.HermesExecutor`
...
from goalrail.inner.hermes_executor import HermesExecutor
...
def _build_hermes_executor() -> Executor:
    ...
    return HermesExecutor(
        ...
        cwd=os.environ.get(_ENV_CWD) or os.environ.get("GOALRAIL_RUNNER_WORKSPACE"),
