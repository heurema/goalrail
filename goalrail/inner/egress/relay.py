...
``Proxy-Authorization: Basic <base64(goalrail:token)>`` header on
every inbound connection, with the token shared between parent and
helper via :class:`goalrail.inner.sandbox.SandboxPolicy.
...
net protection gain. See ``goalrail/inner/os_env.py:
