...
:mod:`goalrail.spec.types`; runtime evaluation types live
here.
...
:mod:`goalrail.policies` package entry point).
"""
...
from goalrail.spec.types import Phase, PolicyAction, StateUpdate
...
# (``goalrail.runner.app`` and ``goalrail.runtime.harnesses._scaffold``)
...
class EvaluationContext:
    ...
    :param llm_client: An :class:`~goalrail.policies.types.PolicyLLMClient`
...
class PolicyLLMClient:
    ...
    Wraps an :class:`~goalrail.llms.client.Client` with the
    ...
    :param _client: The underlying multi-provider LLM client.
        An :class:`~goalrail.llms.client.Client` instance
    ...
    _client: Any  # goalrail.llms.client.Client — Any to avoid import cycle
    _model: str
    ...
    async def create(
        ...
        **kwargs: Any,
        ...
        :returns: A :class:`~goalrail.llms.types.Response`.
        """
