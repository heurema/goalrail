...
See ``designs/GOALRAIL_TERMINAL_BRIDGE.md`` for the design and the
:class:`TerminalInstance` documentation in
:mod:`goalrail.inner.terminal` for the underlying tmux machinery.
"""

from goalrail.terminals.registry import TerminalListEntry, TerminalRegistry
