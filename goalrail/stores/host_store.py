...
Hosts are machines connected via ``goalrail host``. The store
...
from goalrail.db.db_models import SqlConversation, SqlHost
from goalrail.db.utils import get_or_create_engine, make_managed_session_maker, now_epoch
        ...
        with self._session() as session:
            ...
            if row is not None:
                if row.host_id != host_id:
                    ...
                    # ~/.goalrail. host_id is a UNIQUE column that
