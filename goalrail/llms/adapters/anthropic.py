...
from goalrail.llms.adapters._content import parse_data_uri
from goalrail.llms.adapters.base import BaseAdapter
from goalrail.reasoning_effort import ANTHROPIC_EFFORTS, validate_effort_or_llm_error
...
def _build_headers(
    ...
    :raises GoalrailError: If no API key is provided.
    """
