...
from goalrail.llms._responses_to_chat import (
    chat_response_to_response,
    chat_stream_to_response_events,
    responses_input_to_chat_messages,
)
from goalrail.llms._usage_observer import notify as _notify_usage
from goalrail.llms.adapters import get_adapter
from goalrail.llms.adapters.openai import OpenAIAdapter
...
from goalrail.reasoning_effort import OPENAI_EFFORTS, validate_effort_or_llm_error
from goalrail.runtime.llm_retry import classify_llm_error
...
async def _sleep(seconds: float) -> None:
    ...
    ``asyncio.sleep`` globally (patching ``goalrail.llms.client.asyncio.sleep``
