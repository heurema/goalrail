...
injects web-UI turns into it (see :mod:`goalrail.kimi_native_bridge`). The TUI's
...
:mod:`goalrail.cursor_native_forwarder`.
...
``/v1/sessions/{id}/events`` (the same shape :mod:`goalrail.kimi_native_hook`
