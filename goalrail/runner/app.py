...
class _PiNativeLaunchConfig:
    ...
    :param fork_carry_history: ``True`` when the session is a fork bound to a
        carry-history native target (``goalrail.fork.carry_history``). Consumed
...
async def _auto_create_qwen_terminal(
    ...
    *,
    ...
    async def _supervise_qwen_native_bridges() -> None:
        ...
        elicitations (see :mod:`goalrail.qwen_native_permissions`).
        """
        await asyncio.gather(
...
async def _auto_create_claude_terminal(
    ...
    *,
    ...
    # Goalrail session carries a stale bridge_id label from a prior rotation that
    ...
    *,
    ...
    async def _ensure_comment_relay_started(
        ...
        *,
        ...
        from goalrail.runner.tool_dispatch import _NATIVE_RELAY_BUILTIN_TOOLS
        ...
        from goalrail.tools.builtins.os_env import (
            SysOsEditTool,
            SysOsReadTool,
            SysOsShellTool,
            SysOsWriteTool,
        )
        from goalrail.tools.builtins.spawn import (
        ...
        # giving centralized policy evaluation on the Goalrail server. Two groups
        # are assembled:
        #
