...
:mod:`goalrail.runtime.session_stream`, the registry is process-local
...
# subscriber registry in ``goalrail.runtime.session_stream``.
...
def reset_for_tests() -> None:
    ...
    ``goalrail.server._elicitation_registry.reset_for_tests`` —
