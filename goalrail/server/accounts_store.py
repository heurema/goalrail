...
Sibling to :class:`goalrail.stores.permission_store.PermissionStore`
...
from goalrail.db.db_models import SqlAccountToken, SqlUser
from goalrail.db.utils import get_or_create_engine, make_managed_session_maker
from goalrail.entities import Account, AccountToken
from goalrail.server.auth import RESERVED_USER_LOCAL, RESERVED_USER_PUBLIC
...
class SqlAlchemyAccountStore:
    ...
    :param storage_location: SQLAlchemy database URI, e.g.
        ``"sqlite:///goalrail.db"``. Shares the connection pool
    ...
    def create_user_with_password(
        ...
        *,
        ...
        :param password_hash: Pre-hashed password (see
            :mod:`goalrail.server.passwords`). Plaintext never
    ...
    def set_admin(self, user_id: str, is_admin: bool) -> None:
        ...
        (:func:`goalrail.server.admin_list.promote_if_listed`), which
    ...
    def get_password_hash(self, user_id: str) -> str | None:
        ...
        :func:`goalrail.server.passwords.verify_password` — never
