...
class _PreResolvedHarnessElicitation:
    ...
    :param session_id: Goalrail session id that issued the resolution, e.g.
        ``"conv_abc123"``.
...
# race between a native client answering instantly and the Goalrail hook
...
def reset_for_tests() -> None:
    ...
    :func:`goalrail.runtime.pending_elicitations.reset_for_tests`.
