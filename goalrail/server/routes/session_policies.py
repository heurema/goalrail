...
from goalrail.spec.types import FunctionPolicySpec, PolicySpec
...
def create_session_policies_router(
    ...
    def _require_session_exists(session_id: str) -> None:
        ...
        :param session_id: The session to check, e.g.
            ``"conv_abc123"``.
        :raises GoalrailError: 404 if the session is not found.
        """
    ...
    async def create_policy(
        ...
        :raises GoalrailError: 401/403 if the user lacks edit
    ...
    async def list_policies(
        ...
        :raises GoalrailError: 401/403 if the user lacks read
