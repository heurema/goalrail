...
def normalize_for_policy(
    ...
    *,
    ...
    :param goalrail_session_id: Owning Goalrail conversation id.
    ...
    return {
        ...
        "goalrail_session_id": goalrail_session_id,
...
def decision_to_reply(decision: PolicyDecision) -> OpenCodeReply | None:
    ...
    ``permission/index.ts``), which bypasses the Goalrail policy engine and
