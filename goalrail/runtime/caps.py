...
if TYPE_CHECKING:
    ...
    from goalrail.server.smart_routing import RoutingClient
    from goalrail.spec.types import LLMConfig, PolicySpec
...
class RuntimeCaps:
    ...
    :param llm: Server-level LLM configuration for policy
        ...
        :class:`~goalrail.policies.types.PolicyLLMClient`
    ...
    :param policy_llm_connection_factory: Optional callable invoked
        ...
        :class:`~goalrail.policies.types.PolicyLLMClient`. When
    ...
    # Registered by the host application (e.g. goalrail_app.py) to
