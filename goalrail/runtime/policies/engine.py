...
from goalrail.llms.context_window import ModelPricing, compute_llm_cost
...
class PolicyEngine:
    ...
    def apply_label_writes(self, set_labels: dict[str, str]) -> None:
        ...
        Keys with no ``LabelDef`` are set freely (goalrail
    ...
    def reset_turn(self) -> None:
        ...
        Mirrors the goalrail-native semantics in
