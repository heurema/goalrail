...
_USER_DAILY_COST_POLICY_PATH = "goalrail.policies.builtins.cost.user_daily_cost_budget"
...
_ASK_ON_ADD_POLICY_SPEC = FunctionPolicySpec(
    ...
    function=FunctionRef(
        path="goalrail.policies.builtins.safety.ask_on_add_policy",
        arguments=None,
    ),
)
...
def build_policy_engine(
    *,
    ...
    :param server_llm: Server-level LLM configuration from
        ...
        :class:`~goalrail.policies.types.PolicyLLMClient` is
...
def _build_policy_llm_client(
    ...
    The :class:`~goalrail.llms.client.Client` is instantiated lazily
