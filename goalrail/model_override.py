...
# in goalrail/runtime/workflow.py). So unlike the single-vendor harnesses above,
...
def canonical_model_spelling(model: str) -> str:
    ...
    :mod:`goalrail.cost_plan`) compare in this form.
...
def normalize_model_for_provider(model: str, provider_kind: str | None) -> str:
    ...
    :param provider_kind: The child's resolved provider kind from
        :func:`goalrail.model_catalog.resolve_model_provider`, e.g.
