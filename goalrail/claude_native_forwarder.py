    ...
    *,
    ...
    clear_resp = await client.patch(
        ...
        json={
            ...
            # ``goalrail claude --resume``) would put a second forwarder on the
...
async def _forward_available_items(
    *,
    ...
    # statusLine stdin captured by ``goalrail.claude_native_status``
...
async def _post_clear_supersession(
    ...
    *,
    ...
    :param client: Goalrail HTTP client (``base_url`` = AP server).
...
async def _forward_model_from_status(
    ...
    *,
    ...
    wrapper (:mod:`goalrail.claude_native_status`) persists that model into
