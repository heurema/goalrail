...
from goalrail._wrapper_labels import KIRO_NATIVE_WRAPPER_VALUE as _WRAPPER_LABEL_VALUE
...
_KIRO_PATH_ENV = "GOALRAIL_KIRO_PATH"
...
def run_kiro_native(
    *,
    ...
    with TemporaryDirectory(prefix="goalrail-kiro-native-") as tmpdir:
...
def _materialize_kiro_agent_spec(tmpdir: Path, *, model: str | None = None) -> Path:
    """Write the terminal-first agent spec used by ``goalrail kiro``."""
