...
CLOSED_LABEL_KEY = "goalrail.closed"
...
def labels_with_closed_status(
    ...
    New closes persist ``goalrail.closed=true`` directly. Older
    ...
    :param title: Stored conversation title, e.g.
        ``"researcher:auth:closed:conv_abc123"``.
    :returns: A mutable labels dict with ``goalrail.closed=true``
