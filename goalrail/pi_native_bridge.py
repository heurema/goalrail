...
PI_NATIVE_CONFIG_ENV_VAR = "GOALRAIL_PI_NATIVE_CONFIG"

_BRIDGE_ROOT: Path | None = None
_CONFIG_FILE = "config.json"
_EXTENSION_FILE = "goalrail_pi_native_extension.js"
_EXTENSION_PACKAGE = "goalrail.resources.pi_native"
_INBOX_DIR = "inbox"
...
def write_extension_files(
    ...
    *,
    ...
    :param tools: Flat Goalrail tool schemas
        ...
        runner uses), so the Pi agent can invoke Goalrail ``sys_*`` tools with
