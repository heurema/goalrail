...
:mod:`goalrail.inner.seatbelt_sandbox` calls
...
:mod:`goalrail.sandbox.bwrap`).

Like ``linux_bwrap`` on Linux, the Seatbelt backend is the macOS
platform default (selected by :func:`goalrail.inner.sandbox._default_sandbox_for_platform`
...
from goalrail.inner.seatbelt_sandbox import SeatbeltSandboxBackend
