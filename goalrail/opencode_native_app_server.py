...
Mirrors :mod:`goalrail.codex_native_app_server` but for OpenCode's HTTP +
...
is runner-internal — the web UI attaches to Goalrail terminal resources,
...
from goalrail.opencode_native_client import (
...
def filtered_server_env(
    *,
    ...
    :param extra_env: Additional provider env (e.g. from Goalrail setup).
