...
from goalrail_client.tools import ToolMetadata, get_tool_metadata
...
from goalrail.tools._pep723 import parse_inline_metadata
from goalrail.tools._srt import wrap_with_srt
...
class LocalPythonTool(Tool):
    ...
    # ``goalrail.runtime.workflow._dispatch_local_python_tool_async``
    ...
    def _prepend_srt(
        ...
        *,
        ...
        shared :func:`~goalrail.tools._srt.wrap_with_srt` helper
