...
# paths strip this marker and expose ``goalrail.closed=true`` instead.
...
class SysSessionSendTool(Tool):
    ...
    Sub-agent sessions are separate Goalrail agent sessions (own
    ...
    :class:`goalrail.runtime.workflow._AsyncToolHandle`:
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "are separate Goalrail agent sessions (own conversation, "
...
def _spec_opts_into_harness_override(spec: Any) -> bool:
    ...
    ``goalrail/runner/tool_dispatch.py`` (``_subagent_allowed_harnesses``) so
...
def _build_sys_session_send_schema(
    ...
    description = (
        ...
        if sub_specs
            ...
            "Child sessions are separate Goalrail agent sessions (own "
...
class SysSessionShareTool(Tool):
    ...
    (:class:`goalrail.spec.types.SharePolicy`), which is its sole gate:
...
class SysSessionCreateTool(Tool):
    ...
    The child is a separate Goalrail agent session — its own
    ...
    def description(cls) -> str:
        ...
        return (
            ...
            "separate Goalrail agent session — its own conversation, "
                    ...
                    "properties": {
                        ...
                        "config_path": {
                            ...
                            "description": (
                                ...
                                "'.goalrail/agent-configs/helper.yaml'. "
