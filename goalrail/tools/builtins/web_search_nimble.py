...
# so traffic from the Goalrail provider is attributable.
_CLIENT_SOURCE = "goalrail"


def _nimble_url() -> str:
    """Resolve the Nimble Search URL; ``GOALRAIL_NIMBLE_BASE_URL`` overrides for tests."""
    return os.environ.get("GOALRAIL_NIMBLE_BASE_URL", _DEFAULT_NIMBLE_URL)
