...
:class:`~goalrail.onboarding.sandboxes.base.SandboxLauncher` for
...
(``pip install 'goalrail[daytona]'``) imported lazily, so the provider
...
HOST_IMAGE_ENV_VAR: str = "GOALRAIL_DAYTONA_HOST_IMAGE"
"""Environment variable overriding
:data:`~goalrail.onboarding.sandboxes.base.DEFAULT_HOST_IMAGE` for
Daytona sandboxes, e.g. an org-internal copy of the host image
(``ghcr.io/<your-org>/goalrail-host:latest``)."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "GOALRAIL_DAYTONA_SANDBOX_ENV"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "provider. Install it with `pip install 'goalrail[daytona]'`, "
...
class DaytonaSandboxLauncher(SandboxLauncher):
    ...
    def run(self, sandbox_id: str, command: str, *, check: bool = True) -> RemoteCommandResult:
        ...
        :class:`~goalrail.onboarding.sandboxes.base.RemoteCommandResult`
    ...
    def terminate(self, sandbox_id: str) -> None:
        ...
        # not an goalrail dependency — pulling it in for a 3-iteration
