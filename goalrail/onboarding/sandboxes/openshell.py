...
dependency (``pip install 'goalrail[openshell]'``) imported lazily, so
...
HOST_IMAGE_ENV_VAR: str = "GOALRAIL_OPENSHELL_HOST_IMAGE"
"""Environment variable overriding :data:`DEFAULT_HOST_IMAGE` for
OpenShell sandboxes."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "GOALRAIL_OPENSHELL_SANDBOX_ENV"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `pip install 'goalrail[openshell]'`, then select a "
