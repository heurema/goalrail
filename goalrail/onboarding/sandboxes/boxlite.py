...
optional dependency (``pip install 'goalrail[boxlite]'``) imported lazily, so
...
HOST_IMAGE_ENV_VAR: str = "GOALRAIL_BOXLITE_HOST_IMAGE"
"""Environment variable overriding
:data:`~goalrail.onboarding.sandboxes.base.DEFAULT_HOST_IMAGE` for boxlite
boxes, e.g. an org-internal copy of the host image
(``ghcr.io/<your-org>/goalrail-host:latest``)."""

SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "GOALRAIL_BOXLITE_SANDBOX_ENV"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `pip install 'goalrail[boxlite]'`. Local mode also "
...
class BoxliteSandboxLauncher(SandboxLauncher):
    ...
    def __init__(
        ...
        *,
        ...
        :param image: Registry image reference with goalrail pre-installed, e.g.
            ``"docker.io/me/goalrail-host:latest"`` — the server's
