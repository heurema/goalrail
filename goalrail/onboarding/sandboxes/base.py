...
from goalrail.host.identity import HOST_ID_ENV_VAR, HOST_NAME_ENV_VAR, HOST_TOKEN_ENV_VAR
...
DEFAULT_HOST_IMAGE: str = "ghcr.io/heurema/goalrail-host:latest"
...
pins a commit). It bakes the full goalrail install plus git / tmux /
...
def host_image_wheel_install_command(remote_tgz_path: str) -> str:
    ...
    goalrail at the same ``0.1.0`` version. Without it, pip sees the
...
class SandboxLauncher(ABC):
    ...
    def run_background(
        self, sandbox_id: str, command: str, *, log_path: str = "/tmp/goalrail-host.log"
    ) -> RemoteCommandResult:
        """
    ...
    def wheel_install_command(self, remote_tgz_path: str) -> str:
        ...
        :param remote_tgz_path: Where :func:`~goalrail.onboarding.
