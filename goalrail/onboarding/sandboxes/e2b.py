...
the SDK is an optional dependency (``pip install 'goalrail[e2b]'``)
...
- **Templates, not registry images.** Unlike every other launcher, E2B
  ...
  built FROM the same host image (goalrail ``0.1.0`` baked).
...
TEMPLATE_ENV_VAR: str = "GOALRAIL_E2B_TEMPLATE"
...
SANDBOX_ENV_PASSTHROUGH_ENV_VAR: str = "GOALRAIL_E2B_SANDBOX_ENV"
...
DEFAULT_E2B_TEMPLATE: str = "goalrail-host"
...
MAX_LIFETIME_ENV_VAR: str = "GOALRAIL_E2B_MAX_LIFETIME_S"
...
def _ensure_sdk() -> None:
    ...
    try:
        ...
        raise click.ClickException(
            ...
            "Install it with `pip install 'goalrail[e2b]'`, then set "
...
class E2BSandboxLauncher(SandboxLauncher):
    ...
    def wheel_install_command(self, remote_tgz_path: str) -> str:
        ...
        FROM the prebaked host image (goalrail ``0.1.0`` baked).
