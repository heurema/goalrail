...
avoid importing the ``goalrail.tools.builtins`` package (which
...
# transitive import chain from goalrail.tools.builtins.__init__.
_TOOL_CLASSES: dict[str, tuple[str, str]] = {
    "download_file": ("goalrail.tools.builtins.download_file", "DownloadFileTool"),
    "export_agent": ("goalrail.tools.builtins.export_agent", "ExportAgentTool"),
    "list_files": ("goalrail.tools.builtins.list_files", "ListFilesTool"),
    "search_conversations": (
        "goalrail.tools.builtins.search_conversations",
        "SearchConversationsTool",
    ),
    "upload_file": ("goalrail.tools.builtins.upload_file", "UploadFileTool"),
    "web_fetch": ("goalrail.tools.builtins.web_fetch", "WebFetchTool"),
    "web_search": ("goalrail.tools.builtins.web_search", "WebSearchTool"),
}
