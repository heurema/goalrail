...
_SOURCE_REPO_URL = "https://github.com/heurema/goalrail.git"
DATABRICKS_EXTRA_INSTALL_HINT = (
    f'uv tool install --force "goalrail[databricks] @ git+{_SOURCE_REPO_URL}"'
)
...
def databricks_sdk_installed() -> bool:
    ...
    (:mod:`goalrail.runtime.credentials.databricks`), so onboarding flows
