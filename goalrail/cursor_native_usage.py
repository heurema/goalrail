...
the SQLite chat store (tailed by :mod:`goalrail.cursor_native_forwarder`) and
...
:func:`goalrail.cursor_native_bridge.write_hooks_config`) whose command runs
...
def _main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="goalrail.cursor_native_usage")
