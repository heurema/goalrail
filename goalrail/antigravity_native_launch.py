...
from goalrail.onboarding.gemini_auth import gemini_auth_has_credential
...
def should_skip_permissions(
    ...
    * the launch is **headless** — no interactive client will attach to answer
    ...
    :mod:`goalrail.antigravity_native_interactions`). agy exposes no firing
    ...
    .. warning:: The ``headless`` argument is currently derived from the
       ...
       :mod:`goalrail.antigravity_native`). That is sound only while
