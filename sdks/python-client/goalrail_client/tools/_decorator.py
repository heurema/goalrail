...
contract for custom Python tools in goalrail. The decorator:
...
TOOL_MARKER_ATTR = "_goalrail_tool_metadata"
...
def tool(
    ...
    *,
    ...
    """
    Mark a module-level function as an goalrail tool.
    ...
    ``goalrail/tools/builtins/async_inbox.py``). The author-time
