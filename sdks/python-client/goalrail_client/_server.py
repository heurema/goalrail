...
if TYPE_CHECKING:
    from ._client import GoalrailClient
...
class LocalServer:
    ...
    def __init__(
        ...
        *,
        ...
        self._client: GoalrailClient | None = None
    ...
    @property
    def client(self) -> GoalrailClient:
    ...
    async def __aenter__(self) -> LocalServer:
        ...
        self._client = GoalrailClient(base_url=self.base_url)
        return self
    ...
    def _start(self) -> None:
        ...
        self._tmpdir = tempfile.mkdtemp(prefix="goalrail-client-")
        db_uri = f"sqlite:///{self._tmpdir}/chat.db"
        art_loc = f"{self._tmpdir}/artifacts"

        # Resolve the goalrail project root so Alembic can find
        # its migrations directory. Walk up from the agent path or
        # from this file's location looking for goalrail/cli.py.
