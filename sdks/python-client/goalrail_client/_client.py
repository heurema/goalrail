"""GoalrailClient — the top-level client tying all namespaces together."""
...
class GoalrailClient:
    ...
    def __init__(
        ...
        *,
        ...
        default_headers = {"Origin": GOALRAIL_INTERNAL_WS_ORIGIN}
        if headers:
    ...
    async def _fetch_agent_tools(
        ...
        :returns: List of tool-entry dicts with at least ``name``
            ...
            predates F1.
        :raises GoalrailError: If the agents endpoint returns
            a non-2xx (e.g. 404).
        """
    ...
    async def __aenter__(self) -> GoalrailClient:
        return self
