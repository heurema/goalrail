...
:class:`goalrail.server.schemas.SessionResponse`. Note that the
``Session`` class exported from :mod:`goalrail_client._session` is
...
this module's ``Session`` from :mod:`goalrail_client.__init__` —
...
class SessionEventInput:
    """
    Client-side mirror of :class:`goalrail.server.schemas.SessionEventInput`.
...
class Session:
    """
    Client-side mirror of :class:`goalrail.server.schemas.SessionResponse`.
    ...
    Note: distinct from :class:`goalrail_client._session.Session`
    (re-exported as ``goalrail_client.Session``), which is a
...
class SessionsNamespace:
    ...
    :param http: Pre-built ``httpx.AsyncClient`` shared with the
        parent :class:`GoalrailClient`. Owned by the parent;
    ...
    async def create(
        ...
        *,
        ...
        :raises GoalrailError: If the server returns a non-2xx
            status.
        """
    ...
    async def bind_runner(
        ...
        *,
        ...
        :raises GoalrailError: On non-2xx status (404 when the
    ...
    async def set_model_override(
        ...
        *,
        ...
        :param silent: When ``True``, persist without triggering the
            ...
            desired feedback.
        :returns: The updated :class:`Session` snapshot.
        :raises GoalrailError: On non-2xx status (400 on invalid
    ...
    async def set_archived(
        ...
        *,
        ...
        :returns: The updated :class:`Session` snapshot.
        :raises GoalrailError: On non-2xx status (403 without owner
    ...
    async def set_external_session_id(
        ...
        *,
        ...
        :returns: The updated :class:`Session` snapshot.
        :raises GoalrailError: On non-2xx status (400 on
    ...
    async def child_sessions_tree(
        ...
        *,
        ...
        :raises GoalrailError: On non-2xx status (404 when the session does not
            exist).
        """
    ...
    async def subtree_busy(
        ...
        *,
        ...
        :func:`goalrail_client.child_summary_busy` predicate — the same "busy"
    ...
    async def fork(
        ...
        *,
        ...
        :returns: Raw response dict matching the ``SessionResponse``
            ...
            ``items``.
        :raises GoalrailError: 404 if *source_session_id* does
    ...
    async def compact(self, session_id: str) -> None:
        ...
        :param session_id: Session/conversation identifier, e.g.
            ``"conv_abc123"``.
        :raises GoalrailError: If the server returns a non-2xx status.
        """
    ...
    async def stream(
        ...
        :yields: :class:`ServerStreamEvent` envelopes whose ``type`` is a
            :class:`goalrail.server.schemas.ServerStreamEvent`
...
def _try_parse_envelope(raw: str) -> ServerStreamEvent | None:
    ...
    :mod:`goalrail.server.schemas` (e.g. ``{"type":
