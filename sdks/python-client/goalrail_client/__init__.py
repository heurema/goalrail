"""goalrail-client SDK — Python client for the Goalrail server API.
...
Or consume semantic blocks via :class:`BlockStream`::
    ...
    from goalrail_client import BlockStream, pipe, skip_intermediate_ends
...
from ._errors import GoalrailError, ToolCallDenied
