...
func run(
	...
	case "health":
		// The superseded name keeps working and names its successor, because
		// printed remedies and promoted help pointed at it.
		return runHealthAlias(args[1:], stdout, stderr)
	case "hook":
