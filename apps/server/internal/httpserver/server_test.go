...
func TestPublicV1RouteInventoryUsesResourcePaths(t *testing.T) {
	router := httpserver.NewRouter(httpserver.RouteHandlers{
		...
		VcsConnectionCreate:       probeRoute("vcs_connection_create"),
		VcsConnectionGet:          probeRoute("vcs_connection_get"),
	...
	tests := []struct {
		...
		{name: "vcs_connection_create", method: http.MethodPost, path: "/v1/vcs-connections", wantRoute: "vcs_connection_create"},
		{name: "vcs_connection_get", method: http.MethodGet, path: "/v1/vcs-connections/connection-1", wantRoute: "vcs_connection_get"},
...
func TestPublicV1OldVerbStyleRoutesAreNotRegistered(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "vcs_connection_list", method: http.MethodGet, path: "/v1/vcs-connections"},
