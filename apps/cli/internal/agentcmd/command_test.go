...
func TestInstallCreatesAgentPackFiles(t *testing.T) {
	...
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "next_action.kind=ask_user")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "next_action.kind=draft_contract")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "next_action.kind=update_contract")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "next_action.kind=review_contract")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail contract submit")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail contract approve --confirm-user-approval")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail work plan")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail work plan status")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail work proposal accept --confirm-user-acceptance")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "Never infer approval from silence")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "Never infer plan acceptance from silence")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "question_id-bound structured JSON")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "local repository receipt")
	assertFileContains(t, filepath.Join(repoDir, agentGuideRelativePath), "goalrail contract update")
	...
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail work answer --clarification-request-id <id> --answers-file - --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail contract draft --goal-id <goal_id> --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail contract update --contract-id <contract_id> --fields-file - --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail contract submit --contract-id <contract_id> --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail contract approve --contract-id <contract_id> --confirm-user-approval --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail work plan --contract-id <contract_id> --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail work plan status --plan-id <plan_id> --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"goalrail work proposal accept --proposal-id <proposal_id> --confirm-user-acceptance --format json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"stdin": "structured_answers_json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"stdin": "structured_contract_fields_json"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"ClarificationAnswer"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"ContractDraft"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"ApprovedContract"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"explicit_user_approval"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"explicit_user_acceptance"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"local_repo_receipt"`)
	assertFileContains(t, filepath.Join(repoDir, agentCommandsRelativePath), `"raw_source"`)
