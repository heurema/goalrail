...
- `goalrail/cli.py`
- `goalrail/onboarding/provider_config.py`
- `goalrail/onboarding/secrets.py`
- `goalrail/runner/_entry.py`
...
The fresh default intentionally remains `~/.goalrail` for now. This avoids a
...
- Full state directory default migration from `~/.goalrail` to `~/.goalrail`.
- Data directory and daemon-state compatibility (`GOALRAIL_DATA_DIR`,
