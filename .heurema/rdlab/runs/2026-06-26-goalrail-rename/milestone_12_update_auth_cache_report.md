...
- `goalrail/update_check.py`
- `goalrail/cli_auth.py`
...
```sh
uv run pre-commit run --files goalrail/update_check.py goalrail/cli_auth.py tests/cli/test_update_check.py tests/cli/test_cli_auth.py .heurema/rdlab/runs/2026-06-26-goalrail-rename/milestone_12_update_auth_cache_report.md
```
