...
```sh
uv run pre-commit run --files tests/scripts/test_update_versions.py tests/cli/test_configure_models.py .heurema/rdlab/runs/2026-06-26-omnigent-to-goalrail-rename/milestone_14_pytest_unblock_report.md
```
