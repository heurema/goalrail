...
- Do not vendor codebase-memory-mcp into Goalrail.
- Do not make it a hidden Goalrail wheel dependency.
...
semantics, Goalrail should pin a minimum version and keep tests around the
commands it invokes.
