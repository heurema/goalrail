...
|---|---|---|---|---|
| S01 | `/Users/vi/personal/heurema/omnigent/scripts/install_oss.sh` | code | local | Installer flags, fatal/warning helpers, Omnigent install sequence |
| S02 | `/Users/vi/personal/heurema/omnigent/tests/scripts/test_install_oss.py` | test | local | Existing shell-library test pattern for installer changes |
| S03 | `/Users/vi/personal/heurema/omnigent/omnigent/cli.py` | code | local | `omnigent setup` command and setup side-effect location |
| S04 | `/Users/vi/personal/heurema/omnigent/omnigent/onboarding/sandboxes/base.py` | code | local | Remote host image and `pip --no-deps` wheel overlay behavior |
...
- Omnigent code implementation edits: out of scope for this run.
