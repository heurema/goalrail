...
- small diff;
- low risk;
- Omnigent install remains reliable;
...
Keep installer to binary + auto_index only. Add `omnigent setup` check/repair
...
deletion prompts, then call that from Omnigent.

Pros:
- safest long-term command surface;
- avoids Omnigent parsing CBM internals.
