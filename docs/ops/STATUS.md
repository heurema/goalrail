...
- `apps/web/console` is the EN real console shell with login-only entry, three empty product surfaces, bottom-left Settings utility, and Users add/edit UI in component state only
