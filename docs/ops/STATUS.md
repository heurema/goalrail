...
repo-side update. CI hardening, branch protection, and PII / abuse / retention
...
- `apps/web/pilot-intake-ru` is the current local React + Vite + Mantine RU business-first pilot landing prototype for `pilot.goalrail.ru` (`ИИ-кодинг без хаоса`, safe 2-week пилот ИИ-разработки, repository readiness, project context, controlled tasks, verified result); it supersedes the previous technical interactive walkthrough as the primary public RU landing per D-0055.
