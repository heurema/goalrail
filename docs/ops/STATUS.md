...
- `apps/web/console` is the EN real console shell with login-only entry, three empty product surfaces, bottom-left Settings utility, Appearance theme picker, and Users add/edit UI in component state only
...
- `apps/web/console-ru` is the separate Russian console shell for `console.goalrail.ru`, live as a static HTTPS surface with login-only entry, three empty product surfaces, bottom-left Settings utility, Appearance theme picker, and Users add/edit UI in component state only
